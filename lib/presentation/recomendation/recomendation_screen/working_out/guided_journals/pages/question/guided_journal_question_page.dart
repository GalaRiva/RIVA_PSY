...
class _QuestionBodyState extends State<_QuestionBody> {
  late final answerController = TextEditingController(text: widget.initialAnswer);
    ...
    return SingleChildScrollView(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              'guided_journal_question_progress'
                  .tr(args: ['${widget.questionNumber}', '${widget.totalQuestions}']),
              style: AppStyle.txtSFProDisplayLight12.copyWith(color: ColorConstant.gray800),
            ),
            SizedBox(height: getVerticalSize(10)),
            Text(widget.question, style: AppStyle.txtH2),
            ...
            CustomButton(
              text: (widget.isLast ? 'guided_journal_finish'.tr() : 'continue'.tr()).toUpperCase(),
