                  ...
                  onTap: () {
                    ...
                    MaterialPageRoute(builder: (_) => K22Screen(dayEvent: cubit.dayEventModel, onSave: (event) {
                      MaterialPageRoute(builder: (_) => K25Screen(dayEvent: event, onSave: (event) {
                        MaterialPageRoute(builder: (_) => K26Screen(dayEvent: event, onSave: (event) {
                          MaterialPageRoute(builder: (_) => K27Screen(dayEvent: event, emotionsTypes: [EmotionInDayEvent.POSITIVE, EmotionInDayEvent.NEUTRAL], onSave: (event, emotions, category) {
                            MaterialPageRoute(builder: (_) => K31Screen(dayEvent: event,category: category, someEmotions: emotions,  onSave: (event) {
                              MaterialPageRoute(builder: (_) => K32Screen(dayEvent: event, onSave: (event) {
